...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1265: (x0,x1) => x0.canShare(x1),
      _1266: (x0,x1) => x0.share(x1),
      _1268: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      _1269: (x0,x1) => ({files: x0,text: x1}),
      _1270: (x0,x1) => ({files: x0,title: x1}),
      _1271: x0 => ({files: x0}),
      _1272: (x0,x1) => ({title: x0,text: x1}),
      _1274: (x0,x1) => x0.createElement(x1),
      _1275: x0 => x0.click(),
      _1288: (x0,x1) => x0.createElement(x1),
      _1294: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1295: x0 => x0.load(),
      _1296: x0 => x0.play(),
      _1297: x0 => x0.pause(),
      _1300: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1301: (x0,x1) => x0.removeAttribute(x1),
      _1302: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1303: (x0,x1) => x0.start(x1),
      _1304: (x0,x1) => x0.end(x1),
      ...
      _1315: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1318: x0 => x0.send(),
      _1319: () => new XMLHttpRequest(),
      _1320: (x0,x1) => x0.getItem(x1),
      _1321: (x0,x1) => x0.removeItem(x1),
      _1322: (x0,x1,x2) => x0.setItem(x1,x2),
      _1323: (x0,x1) => x0.querySelector(x1),
      _1324: x0 => ({type: x0}),
      _1325: (x0,x1) => new Blob(x0,x1),
      _1326: x0 => globalThis.URL.createObjectURL(x0),
      _1327: (x0,x1) => x0.item(x1),
      _1328: () => new FileReader(),
      _1330: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1363: s => JSON.stringify(s),
      _1364: s => printToConsole(s),
      ...
      _1376: Object.is,
      _1377: o => o instanceof Array,
      _1378: (a, i) => a.push(i),
      _1381: (a, l) => a.length = l,
      _1382: a => a.pop(),
      _1383: (a, i) => a.splice(i, 1),
      _1384: (a, s) => a.join(s),
      _1385: (a, s, e) => a.slice(s, e),
      _1387: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1388: a => a.length,
      _1389: (a, l) => a.length = l,
      _1390: (a, i) => a[i],
      _1391: (a, i, v) => a[i] = v,
      _1393: o => {
      ...
      _1394: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1396: o => o instanceof Uint8Array,
      _1397: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1398: o => o instanceof Int8Array,
      _1399: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1400: o => o instanceof Uint8ClampedArray,
      _1401: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1402: o => o instanceof Uint16Array,
      _1403: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1404: o => o instanceof Int16Array,
      _1405: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1406: o => o instanceof Uint32Array,
      _1407: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1408: o => o instanceof Int32Array,
      _1409: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1411: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1412: o => o instanceof Float32Array,
      _1413: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1414: o => o instanceof Float64Array,
      _1415: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1416: (t, s) => t.set(s),
      _1417: l => new DataView(new ArrayBuffer(l)),
      _1418: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1420: o => o.buffer,
      _1421: o => o.byteOffset,
      _1422: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1423: (b, o) => new DataView(b, o),
      _1424: (b, o, l) => new DataView(b, o, l),
      _1425: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1426: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1427: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1428: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1429: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1430: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1431: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1432: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1433: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1434: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1435: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1436: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1439: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1440: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1441: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1442: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1443: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1444: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1457: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1458: (handle) => clearTimeout(handle),
      _1459: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1460: (handle) => clearInterval(handle),
      _1461: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1462: () => Date.now(),
      _1467: o => Object.keys(o),
      _1468: (x0,x1) => new WebSocket(x0,x1),
      _1469: (x0,x1) => x0.send(x1),
      _1470: (x0,x1,x2) => x0.close(x1,x2),
      _1471: (x0,x1) => x0.close(x1),
      _1472: x0 => x0.close(),
      _1473: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1474: (x0,x1) => globalThis.fetch(x0,x1),
      _1475: (x0,x1) => x0.get(x1),
      _1476: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1476(f,arguments.length,x0,x1,x2) }),
      _1477: (x0,x1) => x0.forEach(x1),
      _1478: x0 => x0.abort(),
      _1479: () => new AbortController(),
      _1480: x0 => x0.getReader(),
      _1481: x0 => x0.read(),
      _1482: x0 => x0.cancel(),
      _1483: x0 => new BroadcastChannel(x0),
      _1484: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1484(f,arguments.length,x0) }),
      _1485: (x0,x1) => x0.postMessage(x1),
      _1486: x0 => x0.close(),
      _1496: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1496(f,arguments.length,x0) }),
      _1497: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1497(f,arguments.length,x0) }),
      _1506: (x0,x1) => x0.key(x1),
      _1516: (s, m) => {
        try {
      ...
      _1575: (o, p) => o[p],
      _1578: x0 => x0.random(),
      _1579: (x0,x1) => x0.getRandomValues(x1),
      _1580: () => globalThis.crypto,
      _1581: () => globalThis.Math,
      _1582: Function.prototype.call.bind(Number.prototype.toString),
      _1583: Function.prototype.call.bind(BigInt.prototype.toString),
      _1584: Function.prototype.call.bind(Number.prototype.toString),
      _1585: (d, digits) => d.toFixed(digits),
      _1589: () => globalThis.document,
      _1595: (x0,x1) => { x0.height = x1 },
      _1597: (x0,x1) => { x0.width = x1 },
      _1606: x0 => x0.style,
      _1609: x0 => x0.src,
      _1610: (x0,x1) => { x0.src = x1 },
      _1611: x0 => x0.naturalWidth,
      _1612: x0 => x0.naturalHeight,
      _1628: x0 => x0.status,
      _1629: (x0,x1) => { x0.responseType = x1 },
      _1631: x0 => x0.response,
      _1741: (x0,x1) => { x0.draggable = x1 },
      _1757: x0 => x0.style,
      _2329: x0 => x0.videoWidth,
      _2330: x0 => x0.videoHeight,
      _2334: (x0,x1) => { x0.playsInline = x1 },
      _2360: x0 => x0.error,
      _2362: (x0,x1) => { x0.src = x1 },
      _2371: x0 => x0.buffered,
      _2374: x0 => x0.currentTime,
      _2375: (x0,x1) => { x0.currentTime = x1 },
      _2376: x0 => x0.duration,
      _2381: (x0,x1) => { x0.playbackRate = x1 },
      _2388: (x0,x1) => { x0.autoplay = x1 },
      _2390: (x0,x1) => { x0.loop = x1 },
      _2392: (x0,x1) => { x0.controls = x1 },
      _2394: (x0,x1) => { x0.volume = x1 },
      _2396: (x0,x1) => { x0.muted = x1 },
      _2411: x0 => x0.code,
      _2412: x0 => x0.message,
      _2485: x0 => x0.length,
      _2681: (x0,x1) => { x0.accept = x1 },
      _2695: x0 => x0.files,
      _2721: (x0,x1) => { x0.multiple = x1 },
      _2739: (x0,x1) => { x0.type = x1 },
      _3458: () => globalThis.window,
      _3501: x0 => x0.location,
      _3520: x0 => x0.navigator,
      _3784: x0 => x0.localStorage,
      _3792: x0 => x0.href,
      _3907: x0 => x0.userAgent,
      _3958: x0 => x0.data,
      _4005: (x0,x1) => { x0.onmessage = x1 },
      _4112: x0 => x0.length,
      _4329: x0 => x0.readyState,
      _4342: (x0,x1) => { x0.binaryType = x1 },
      _4345: x0 => x0.code,
      _4346: x0 => x0.reason,
      _6054: x0 => x0.signal,
      _6115: x0 => x0.firstChild,
      _6126: () => globalThis.document,
      _6541: (x0,x1) => { x0.id = x1 },
      _6568: x0 => x0.children,
      _7887: x0 => x0.value,
      _7889: x0 => x0.done,
      _8069: x0 => x0.size,
      _8070: x0 => x0.type,
      ...
      _8584: x0 => x0.url,
      _8586: x0 => x0.status,
      _8588: x0 => x0.statusText,
      _8589: x0 => x0.headers,
      _8590: x0 => x0.body,
      _10718: (x0,x1) => { x0.border = x1 },
      _10996: (x0,x1) => { x0.display = x1 },
      _11160: (x0,x1) => { x0.height = x1 },
      _11850: (x0,x1) => { x0.width = x1 },
      _12218: x0 => x0.name,
      _12219: x0 => x0.message,
